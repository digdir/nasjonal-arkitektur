...
- **Nasjonal arkitektur for samhandling** - *Evne til å sikre samhandling, gjenbruk og strategisk retning i et nasjonalt digitalt økosystem.*
  ...
  - **Strategisk styring** - *Evne til å sette retning for nasjonal arkitektur og realisere strategiske mål.*
    - **Finansiering** - *Evne til å etablere, anvende og forvalte finansielle virkemidler for å styre digitalisering i tråd med nasjonale mål.*
    ...
    - **Samordning** - *Evne til å harmonisere og koordinere strategisk retning, beslutninger og ressursbruk på tvers av virksomheter, for å realisere felles samfunnsmål og sammenhengende tjenester.*
  ...
  - **Informasjonssikkerhet** - *Evne til å ha tilstrekkelig sikkerhet i tjenester og løsninger som benyttes i felles økosystem.*
    ...
    - **Sikring av informasjonsflyt og datautveksling** - *Evne til å sikre at informasjon som utveksles mellom virksomheter er beskyttet mot innsyn og manipulering, og at dataflyten er kontrollert gjennom nødvendige tekniske og organisatoriske tiltak.*
  - **Informasjonsforvaltning** - *Evne til å ha et felles rammeverk og styringsmodell for informasjonsforvaltning, slik at offentlige virksomheter kan utveksle og dele data og beskrivelser.*
    ...
    - **Oversikt over API ** - *Evne til å understøtte datadeling og tjenesteintegrasjon ved å oppdage, forstå og koble seg til tilgjengelige data via en standardisert oversikt over maskinlesbare grensesnitt (API-er).*
  ...
  - **Datadrevet** - *Evne til å systematisk bruke data som en strategisk ressurs for å skape innsikt, informere beslutninger og utvikle bedre, mer treffsikre og effektive tjenester.*
    - **Dataanalyse** - *Evne til å transformere rådata til meningsfull innsikt og bygge prediktive modeller.*
